...
yahal::mcu::targets::msp430f5309::I2CMaster::I2CMaster(const Configuration& configuration) :
...
void yahal::mcu::targets::msp430f5309::I2CMaster::doInit(void)
{
...
void yahal::mcu::targets::msp430f5309::I2CMaster::start(uint8_t slaveAddress, Direction::Type direction)
{
...
void yahal::mcu::targets::msp430f5309::I2CMaster::stop(void)
{
...
void yahal::mcu::targets::msp430f5309::I2CMaster::writeBufferTX(uint8_t byte)
{
	UCB1TXBUF = byte;
}
...
uint8_t yahal::mcu::targets::msp430f5309::I2CMaster::readBufferRX(void)
{
	return UCB1RXBUF;
}
...
void yahal::mcu::targets::msp430f5309::I2CMaster::awaitTransmissionEnd(void)
{
...
void yahal::mcu::targets::msp430f5309::I2CMaster::isr(IRQHandler::UsciB1::IRQ::Type irq)
{
	switch (irq)
	{

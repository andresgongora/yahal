...
yahal::mcu::targets::msp430f5309::I2CMultimaster::I2CMultimaster(const Configuration& configuration) :
...
void yahal::mcu::targets::msp430f5309::I2CMultimaster::doInit(void)
{
...
void yahal::mcu::targets::msp430f5309::I2CMultimaster::start(uint8_t slaveAddress, Direction::Type direction)
{
...
void yahal::mcu::targets::msp430f5309::I2CMultimaster::stop(void)
{
...
void yahal::mcu::targets::msp430f5309::I2CMultimaster::writeBufferTX(uint8_t byte)
{
	UCB1TXBUF = byte;
}
...
uint8_t yahal::mcu::targets::msp430f5309::I2CMultimaster::readBufferRX(void)
{
	return UCB1RXBUF;
}
...
void yahal::mcu::targets::msp430f5309::I2CMultimaster::awaitTransmissionEnd(void)
{
...
bool yahal::mcu::targets::msp430f5309::I2CMultimaster::isIncommingWrite(void)
{
	return (UCB1CTL1 & UCTR);
}


bool yahal::mcu::targets::msp430f5309::I2CMultimaster::isMaster(void)
{
	return (UCB1CTL0 & UCMST);
}


void yahal::mcu::targets::msp430f5309::I2CMultimaster::configureAsMaster(void)
{
